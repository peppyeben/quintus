...
class MarketResolver {
    ...
    async resolveMarket(matchResult, queryResult, possibleOutcomes) {
        const prompt = this.constructPrompt(matchResult, queryResult, possibleOutcomes);
        try {
    ...
    constructPrompt(matchResult, queryResult, possibleOutcomes) {
...
exports.default = MarketResolver;
