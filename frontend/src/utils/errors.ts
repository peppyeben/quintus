...
export const translateError = (error: any): TranslatedError => {
    ...
    const contractErrorMap: Record<string, TranslatedError> = {
        'InvalidBetDeadline()': {
            ...
            userMessage: 'The bet deadline is invalid. Please select a future date.',
        },
        'InvalidResolutionDeadline()': {
            type: ErrorType.INVALID_RESOLUTION_DEADLINE,
            userMessage: 'The resolution deadline is invalid. It must be after the bet deadline.',
        },
        'InsufficientOutcomes()': {
            type: ErrorType.INSUFFICIENT_OUTCOMES,
            userMessage: 'You must provide at least two outcomes for the market.',
        },
        'InsufficientFee()': {
        ...
        'BettingDeadlinePassed()': {
            ...
            userMessage: 'The betting deadline has passed. You can no longer place bets.',
        },
        ...
        'UnauthorizedOracle()': {
            ...
            userMessage: 'Unauthorized access. Only designated oracles can perform this action.',
        },
        'NoWinningsToClaim()': {
    ...
    for (const [errorSignature, translation] of Object.entries(contractErrorMap)) {
    ...
    if (checkErrorMessage(errorMessage, userRejectionPatterns)) {
        return {
            ...
            userMessage: 'Transaction was cancelled. Please try again if you wish to proceed.',
            technicalMessage: errorMessage
        };
    }
    ...
    if (checkErrorMessage(errorMessage, insufficientFundsPatterns)) {
        return {
            ...
            userMessage: 'Insufficient funds to complete this transaction. Please add more funds to your wallet.',
            technicalMessage: errorMessage
        };
    }
